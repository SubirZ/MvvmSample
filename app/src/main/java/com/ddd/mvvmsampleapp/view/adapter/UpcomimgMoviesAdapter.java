...
public class UpcomimgMoviesAdapter extends RecyclerView.Adapter<UpcomimgMoviesAdapter.MoviesViewHolder> {
    private Context mContext;
    private List<UpcomingResult> moviesList = new ArrayList<>();
    private OnMovieItemClick listener;
    private LayoutInflater inflater;

    public UpcomimgMoviesAdapter(Context mContext, List<UpcomingResult> moviesList, OnMovieItemClick listener) {
